...
class m191207_174000_pilgrim extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('pilgrim', [
            ...
            'pilgrim_type_id' => $this->integer()->notNull(),
        ...
        $this->addForeignKey('fk-pilgrim-mahram_id', 'pilgrim', 'mahram_id', 'pilgrim', 'id', 'CASCADE');

        $this->createIndex('idx-pilgrim-mahram_name_id', 'pilgrim', 'mahram_name_id');
        $this->addForeignKey('fk-pilgrim-mahram_name_id', 'pilgrim', 'mahram_name_id', 'mahram_name', 'id', 'CASCADE');

        $this->createIndex('idx-pilgrim-group_id', 'pilgrim', 'group_id');
        $this->addForeignKey('fk-pilgrim-group_id', 'pilgrim', 'group_id', 'group', 'id', 'CASCADE');

        $this->createIndex('idx-pilgrim-pilgrim_type_id', 'pilgrim', 'pilgrim_type_id');
        $this->addForeignKey('fk-pilgrim-pilgrim_type_id', 'pilgrim', 'pilgrim_type_id', 'pilgrim_type', 'id', 'CASCADE');

        $this->createIndex('idx-pilgrim-user_id', 'pilgrim', 'user_id');
        $this->addForeignKey('fk-pilgrim-user_id', 'pilgrim', 'user_id', 'user', 'id', 'CASCADE');
    }
